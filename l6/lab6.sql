...
select * from rasters.porto_parishes;
...
FROM rasters.landstat AS a, vectors.porto_parishes AS b
...
-- ST_SummaryStats + lepsza kontrola zlozonego typu danych
WITH t AS (
...
---- constraints
SELECT AddRasterConstraints('rasters'::name,'tpi30'::name,'rast'::name);
